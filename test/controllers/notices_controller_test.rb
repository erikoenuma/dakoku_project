...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post notices_url, params: { notice: { contents: @notice.contents, user_project_id: @notice.user_project_id } }
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { contents: @notice.contents, user_project_id: @notice.user_project_id } }
